...
<head>
    ...
    <title>{{ config('app.name', 'Admin User') }}</title>
                ...
                @else
                    ...
                    @if($auth_user->roles == 'admin')
                        <ul class="navbar-nav me-auto custom_btn_list">
                            ...
                            <li><a class="custom_btn" href="{{ route('outlet.index') }}">Outlets</a></li>
                        </ul>
                    @else
                        <ul class="navbar-nav me-auto custom_btn_list">
                            <li><a class="custom_btn" href="#">Cart (<span>0</span>)</a></li>
                            <li><a class="custom_btn" href="{{ url('/user-profile') }}">Profile</a></li>
